...
SELECT EMP_NAME , SALARY * 12 "연봉" , SALARY * 12 + BONUS "보너스" , (SALARY * 12 + BONUS) - SALARY * 12 *0.03 실수령액
FROM EMPLOYEE;
...
SELECT EMP_NAME , SALARY , SALARY * 12 실수령액 , QUIT_DATE - HIRE_DATE 고용일
FROM EMPLOYEE
...
SELECT * 
FROM EMPLOYEE
WHERE EMAIL LIKE '___\_%' ESCAPE '\' AND DEPT_CODE IN ('D9','D6') 
