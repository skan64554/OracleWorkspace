...
SELECT S.STUDENT_NO "학번" , STUDENT_NAME "학생 이름", ROUND(AVG(POINT),1) AS "전체 평점"
FROM TB_STUDENT S
...
/*
LEFT JOIN TB_CLASS PROFESSOR CP USING(CLASS_NO)
JOIN TB_DEAPRTMENT USING(DEPARTMENT_NO)
