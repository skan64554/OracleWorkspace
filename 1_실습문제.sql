...
SELECT EMP_NAME , SALARY * 12 "연봉" , (SALARY + SALARY+BONUS) * 12 "보너스" , ((SALARY + SALARY+BONUS) * 12) - (SALARY * 12 *0.03) 실수령액
FROM EMPLOYEE;
...
SELECT EMP_NAME , SALARY , ((SALARY + SALARY+BONUS) * 12) - (SALARY * 12 *0.03) , HIRE_DATE 고용일
FROM EMPLOYEE
